...
def add_annotation(pil_image: Image.Image, annotation: str, position: str = 'top', alignment: str = 'center', size: str = 'default'):
    """
    ...
    text_x, text_y = calculate_text_position(img_width, img_height, text_width, text_height, position, alignment, padding)
...
def add_annotations(pil_image: Image.Image, annotations: list, position: str = 'top'):
    ...
    for annotation, align, size in annotations:
        font = get_font_size(annotation, max_width, max_height, font, size)
        text_width, text_height = textsize(annotation, font)
        text_x, text_y = calculate_text_position(img_width, img_height, text_width, max_text_height, position, align, padding)
        draw.text((text_x, text_y), annotation, fill="black", font=font)
